...
Uses predefined fire hazard locations with ACTIVE_FIRE_NAME selector.
Routes users to nearest safe zone via NetworkX shortest path on NTU
campus walking network. Syncs evacuee status to Supabase.
"""
...
# =========================================================
ACTIVE_FIRE_NAME = os.getenv("ACTIVE_FIRE_NAME", "The Hive")
